...
public class JMEPlayEditorTopMenuFileTest extends TestFxApplicationTest {
    ...
    @Test
    public void testJMEPlayEditorTopMenuFile() {
        ...
        jmePlayEditor.menuBarChange().addListener(il -> {
            ...
            Assert.assertTrue(jmePlayEditor.menuBar().getMenus().stream().anyMatch(menu -> menu.getId().equals("menufile")));
        });
        Platform.runLater(() -> {
