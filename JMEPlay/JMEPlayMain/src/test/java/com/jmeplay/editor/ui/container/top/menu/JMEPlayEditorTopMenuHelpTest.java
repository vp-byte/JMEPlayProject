...
public class JMEPlayEditorTopMenuHelpTest extends TestFxApplicationTest {
    ...
    @Test
    public void testJMEPlayEditorTopMenuHelp() {
        ...
        jmePlayEditor.menuBarChange().addListener(il -> {
            ...
            Assert.assertTrue(jmePlayEditor.menuBar().getMenus().stream().anyMatch(menu -> menu.getId().equals("menuhelp")));
        });
        Platform.runLater(() -> {
