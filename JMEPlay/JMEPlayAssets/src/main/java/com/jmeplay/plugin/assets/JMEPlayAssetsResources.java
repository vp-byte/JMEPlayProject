...
public class JMEPlayAssetsResources {
    ...
    public final static String ICONS_ASSETS_NEWFILE = JMEPlayGlobalResources.ICONS + "plugin/assets/JMEPlayAssetsNewFile.svg";
